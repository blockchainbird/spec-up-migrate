 ...
 * @returns {Object} Transformed Spec-Up-T specification object
 */
function transformSpecToSpecUpT(spec, options = {}) {
  ...
  // Always copy spec_directory and output_path from boilerplate if available
  if (boilerplateSpec) {
    if (boilerplateSpec.spec_directory) {
    ...
    if (boilerplateSpec.output_path) {
